#!/usr/bin/env node
/**
 * F1スケジュールデータを最新情報に更新するスクリプト（2020年〜2025年）
 *
 * 使用方法:
 * pnpm tsx server/scripts/updateF1DataRecent.ts
 */
...
async function main() {
  try {
    console.log('Starting F1 data update (2020-2025)...');
    ...
    console.log(`\nSummary:`);
    console.log(`  Total years: ${Object.keys(racesByYear).length} (2020-2025)`);
